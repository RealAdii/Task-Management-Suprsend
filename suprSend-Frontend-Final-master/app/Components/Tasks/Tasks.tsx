...
const TaskStyled = styled.main`
  ...
  .button-container {
    display: flex;
    justify-content: flex-end; /* Aligns children (the inbox and button) to the end */
    align-items: center; /* Centers children vertically */
    padding-right: 2rem; /* Adds spacing to the right */
  }
  ...
  .btn-rounded {
    ...
    margin-left: 1rem; /* Ensures the button is to the right of the SuprSendInbox */
  }
